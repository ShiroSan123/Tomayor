...
const quickActions = [
  {
    icon: Newspaper,
    label: "Что нового?",
    prompt: "Покажи последние важные новости и кратко расскажи о них",
  },
  {
    icon: Calendar,
    label: "События",
    prompt: "Какие интересные события запланированы на ближайшую неделю?",
  },
  {
    icon: Bus,
    label: "Транспорт",
    prompt: "Какая сейчас загруженность транспорта и очереди на переправах?",
  },
  {
    icon: ShoppingBag,
    label: "Товары",
    prompt: "Порекомендуй свежие местные продукты на рынке",
  },
  {
    icon: Bell,
    label: "Уведомления",
    prompt: "Помоги настроить уведомления — какие есть опции?",
  },
  {
    icon: HelpCircle,
    label: "Помощь",
    prompt: "Что ты умеешь и как можешь помочь?",
  },
];
            ...
            <div className="space-y-4">
              <div className="text-center py-6">
                ...
                <p className="text-sm text-slate-500">
                  Могу помочь с рекомендациями, прогнозами и объяснениями
                </p>
              </div>
